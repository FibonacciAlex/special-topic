...
public class DoublyLinkedList {
	...
	public void insert(int data)
	{
		...
		if (head == null)
		{
			// if the list is empty, making both head and tail of the list 
		...
		else
		{
            ...
            //and the next pointer of tail is made to point to null 
			// indicating it is the last node of the list  
			tail.next = null;
		}
	}
