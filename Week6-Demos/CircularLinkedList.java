...
public class CircularLinkedList {
	...
	// defining the head and tail of the circular linked list 
	...
	public void insert(int data)
	{
		...
		if (head == null)
		{
            // If list is empty, making both the head and tail point to the newNode
			// and the next pointer of newNode to head  
			head = newNode;
			tail = newNode;
			newNode.next = head;
		}
		else
		{
            ...
            // and the next pointer of the tail is made to point to the head of the list 
